...
export interface GovernanceTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "s_supply", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "s_supply", data: BytesLike): Result;
...
export interface GovernanceToken extends BaseContract {
  ...
  functions: {
    ...
    s_supply(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    s_supply(overrides?: CallOverrides): Promise<PopulatedTransaction>;
